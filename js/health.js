...
const HealthCheck = (() => {
  ...
  const FEEDS = [
    ...
    { key: 'lgbm_prediction', url: 'data/lgbm-prediction.json',      tsField: 'date' },
    { key: 'trade_recs',     url: 'data/trade-recommendations.json',  tsField: 'date' },
    { key: 'overnight_scan', url: 'data/overnight-scan.json',         tsField: 'scan_time' },
    { key: 'polymarket',     url: 'data/polymarket.json',             tsField: 'date' },
    { key: 'dark_pool',      url: 'data/dark-pool.json',              tsField: 'date' },
    { key: 'morning_brief',  url: 'data/morning-brief.json',          tsField: 'generated_at' },
